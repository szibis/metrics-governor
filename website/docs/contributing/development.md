...
Zstd and snappy always use pure Go regardless of the build tag (klauspost/compress and S2 already outperform their native counterparts). See [compression.md](/docs/operations/compression#native-compression-optional-build-tag-gated) for details.
