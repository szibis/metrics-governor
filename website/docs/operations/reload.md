...
sidebar_position: 3
description: "Hot-reload configuration via SIGHUP"
---
...
For non-Helm deployments, you can use the script at [`deploy/configmap-reload.sh`](https://github.com/szibis/metrics-governor/blob/main/deploy/configmap-reload.sh) directly:
