...
title: "Alerting"
sidebar_position: 3
description: "13 production alert rules with runbooks"
---
...
- [Alert Rules — 10 Alerts, Zero Overlap](#alert-rules--13-alerts-zero-overlap)
...
**Prevent:** Size memory queue for 2x burst duration. Monitor `spillover_active` in Grafana. See [stability-guide.md](/docs/advanced/stability-guide).
...
**Prevent:** Configure upstream senders with retry + exponential backoff. Size pipeline for 1.5x peak. See [stability-guide.md](/docs/advanced/stability-guide).
...
**Prevent:** Size container for stats overhead: `full` needs 50-100 MB headroom. Monitor `heap_alloc_bytes / memory_limit_bytes` ratio. See [stability-guide.md](/docs/advanced/stability-guide).
...
See [SLO documentation](/docs/observability/slo) for full details, and [alerts/slo-alerts.yaml](https://github.com/szibis/metrics-governor/blob/main/alerts/slo-alerts.yaml) for the alert definitions.

---

## See Also

- [SLOs](/docs/observability/slo) — SLI definitions, error budgets, burn-rate alerts, health dashboard
- [Production Guide](/docs/operations/production-guide) — Deployment sizing, resilience tuning, HPA/VPA
- [Resilience](/docs/operations/resilience) — Circuit breaker, backoff, failure modes
- [Performance](/docs/advanced/performance) — Internals, benchmarks, pipeline tuning
- [Limits](/docs/governance/limits) — Rule syntax, adaptive limiting, cardinality
- [Configuration Profiles](/docs/getting-started/profiles) — Profile presets, parameter tables
- [Alert Rules](https://github.com/szibis/metrics-governor/blob/main/alerts/) — Importable rule files
- [Alert Runbooks](https://github.com/szibis/metrics-governor/blob/main/alerts/README.md) — Detailed runbooks for each alert
- [Processing Rules - Dead Rule Detection](/docs/governance/processing-rules#dead-rule-detection) — Detection architecture and metrics
