...
sidebar_position: 1
description: "Internal metrics, stats modes, and self-monitoring"
---
...
These metrics track dynamic configuration reloads via SIGHUP (see [reload.md](/docs/operations/reload)):
...
See [stability-guide.md](/docs/advanced/stability-guide) for tuning guidance.
