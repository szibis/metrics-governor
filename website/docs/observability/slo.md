...
sidebar_position: 4
description: "Error budgets, burn-rate alerts, and SLO dashboards"
---
...
See [alerts/slo-alerts.yaml](https://github.com/szibis/metrics-governor/blob/main/alerts/slo-alerts.yaml) for the full alert definitions.
...
- [Alerting](/docs/observability/alerting) — 13 operational alerts with runbooks
- [Health Endpoints](/docs/operations/health) — Liveness and readiness probes
- [Statistics](/docs/observability/statistics) — Per-metric cardinality and datapoint tracking
- [Performance](/docs/advanced/performance) — Memory optimization and benchmarks
- [Alert Rules README](https://github.com/szibis/metrics-governor/blob/main/alerts/README.md) — Alert runbooks including SLO alerts
