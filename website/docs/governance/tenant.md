...
title: "Multi-Tenancy"
sidebar_position: 4
description: "Per-tenant detection, quotas, and governance"
---
...
Or via Kubernetes ConfigMap sidecar (see [Dynamic Reload](/docs/operations/reload)).
...
See [`examples/limits-tenant-quotas.yaml`](https://github.com/szibis/metrics-governor/blob/main/examples/limits-tenant-quotas.yaml) for a full tiered example using the limits enforcer.
...
- [Limits](/docs/governance/limits) — rule-based adaptive limiting with `group_by`
- [Processing Rules](/docs/governance/processing-rules) — sample, transform, drop by tenant
- [Dynamic Reload](/docs/operations/reload) — hot-reload tenant quotas via SIGHUP
- [Alerting](/docs/observability/alerting) — production alerts including tenant limit violations
- [Production Guide](/docs/operations/production-guide) — sizing for multi-tenant deployments
