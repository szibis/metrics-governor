...
sidebar_position: 2
description: "Filter, transform, sample, downsample, aggregate, classify metrics"
---
...
Processing rules are configured via a YAML file specified with `--processing-config`. See [examples/processing.yaml](https://github.com/szibis/metrics-governor/blob/main/examples/processing.yaml) for a complete example.
...
See [examples/processing-classification.yaml](https://github.com/szibis/metrics-governor/blob/main/examples/processing-classification.yaml) for a complete working example.
...
See [Alerting - Dead Rule Alert Routing](/docs/observability/alerting#dead-rule-alert-routing) for Alertmanager routing setup.
...
For full details on the reload mechanism, ConfigMap sidecar setup, and monitoring, see **[Dynamic Configuration Reload](/docs/operations/reload)**.
...
- **[Export Pipeline](/docs/architecture/exporting)** -- How processed metrics are batched, compressed, and sent to backends
- **[Limits Configuration](/docs/governance/limits)** -- Cardinality and datapoints-rate limiting (downstream of processing)
- **[Configuration Profiles](/docs/getting-started/profiles)** -- Pre-built configuration bundles for common deployment scenarios
- **[Processing Examples](https://github.com/szibis/metrics-governor/blob/main/examples/processing.yaml)** -- Comprehensive example with all 5 actions
- **[Adaptive Downsampling Examples](https://github.com/szibis/metrics-governor/blob/main/examples/processing-adaptive.yaml)** -- Detailed adaptive and LTTB/SDT examples
- **[Transform Examples](https://github.com/szibis/metrics-governor/blob/main/examples/processing-transforms.yaml)** -- All 12 transform operations demonstrated
- **[Tier 1 Edge Processing](https://github.com/szibis/metrics-governor/blob/main/examples/processing-tier1.yaml)** -- DaemonSet edge pre-processing config
- **[Tier 2 Gateway Aggregation](https://github.com/szibis/metrics-governor/blob/main/examples/processing-tier2.yaml)** -- StatefulSet global aggregation config
- **[Dynamic Configuration Reload](/docs/operations/reload)** -- SIGHUP, sidecar setup, and monitoring
