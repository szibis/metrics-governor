---
title: "Cardinality Tracking"
sidebar_position: 3
description: "Bloom filter and HyperLogLog cardinality estimation"
---
...
See [Bloom Persistence](/docs/advanced/bloom-persistence) for persistence configuration.

## See Also

- [Performance](/docs/advanced/performance) - String interning, queue I/O optimizations
- [Bloom Persistence](/docs/advanced/bloom-persistence) - Save/restore filter state across restarts
- [Configuration](/docs/getting-started/configuration) - Full YAML config and CLI flags reference
- [Statistics](/docs/observability/statistics) - Per-metric cardinality and observability
