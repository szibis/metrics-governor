---
title: "Bloom Filter Persistence"
sidebar_position: 2
description: "Persistent bloom filter state across restarts"
---
...
- [Memory Management](#memory-management)
  ...
  - [Memory Sizing Guide](#memory-sizing-guide)
...
- [Logging](#logging)
  - [Startup](#startup)
  - [Periodic Saves](#periodic-saves)
  - [Cleanup](#cleanup)
  - [Shutdown](#shutdown)
- [Usage Examples](#usage-examples)
  - [Basic Usage](#basic-usage)
  - [Production Configuration](#production-configuration)
  - [Docker with Volume](#docker-with-volume)
- [Testing Persistence](#testing-persistence)
  - [Verify State Saved](#verify-state-saved)
...
- [Statistics](/docs/observability/statistics)
- [Resilience](/docs/operations/resilience)
