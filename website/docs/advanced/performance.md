...
title: "Performance"
sidebar_position: 1
description: "vtprotobuf, GOGC tuning, memory optimization"
---
...
See [resilience.md](/docs/operations/resilience) for detailed memory limit documentation.
...
See [limits.md](/docs/governance/limits#per-group-stats-threshold) for full configuration details.
...
See [stability-guide.md](/docs/advanced/stability-guide) for full details.
...
For detailed analysis, test methodology, and delivery ratio investigation, see [COMPARISON-REPORT.md](https://github.com/szibis/metrics-governor/blob/main/test/compare/results/COMPARISON-REPORT.md).
