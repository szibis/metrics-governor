...
validate-playground:
	@echo "Validating playground against Go defaults..."
...
help:
	...
	@echo "  generate-config-meta - Regenerate config-meta JSON in playground HTML"
	@echo "  validate-playground - Validate playground HTML against Go defaults"
