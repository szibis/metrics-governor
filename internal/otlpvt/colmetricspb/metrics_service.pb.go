...
type ExportMetricsServiceRequest struct {
	...
	ResourceMetrics []*metricspb.ResourceMetrics `protobuf:"bytes,1,rep,name=resource_metrics,json=resourceMetrics,proto3" json:"resource_metrics,omitempty"`
...
func (x *ExportMetricsServiceRequest) GetResourceMetrics() []*metricspb.ResourceMetrics {
	if x != nil {
...
const file_opentelemetry_proto_collector_metrics_v1_metrics_service_proto_rawDesc = "" +
	...
	"\x06Export\x12E.opentelemetry.proto.collector.metrics.v1.ExportMetricsServiceRequest\x1aF.opentelemetry.proto.collector.metrics.v1.ExportMetricsServiceResponse\"\x00B\xb0\x01\n" +
	"+io.opentelemetry.proto.collector.metrics.v1B\x13MetricsServiceProtoP\x01Z?github.com/szibis/metrics-governor/internal/otlpvt/colmetricspb\xaa\x02(OpenTelemetry.Proto.Collector.Metrics.V1b\x06proto3"
...
var file_opentelemetry_proto_collector_metrics_v1_metrics_service_proto_goTypes = []any{
	...
	(*metricspb.ResourceMetrics)(nil),    // 3: opentelemetry.proto.metrics.v1.ResourceMetrics
}
