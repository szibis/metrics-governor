...
type Resource struct {
	...
	//
	// Status: [Development]
	EntityRefs    []*commonpb.EntityRef `protobuf:"bytes,3,rep,name=entity_refs,json=entityRefs,proto3" json:"entity_refs,omitempty"`
...
func (x *Resource) GetAttributes() []*commonpb.KeyValue {
	if x != nil {
		return x.Attributes
	}
	return nil
...
func (x *Resource) GetEntityRefs() []*commonpb.EntityRef {
	if x != nil {
		return x.EntityRefs
	}
	return nil
...
const file_opentelemetry_proto_resource_v1_resource_proto_rawDesc = "" +
	...
	"entityRefsB\x96\x01\n" +
	"\"io.opentelemetry.proto.resource.v1B\rResourceProtoP\x01Z=github.com/szibis/metrics-governor/internal/otlpvt/resourcepb\xaa\x02\x1fOpenTelemetry.Proto.Resource.V1b\x06proto3"
...
var file_opentelemetry_proto_resource_v1_resource_proto_goTypes = []any{
	...
	(*commonpb.KeyValue)(nil),  // 1: opentelemetry.proto.common.v1.KeyValue
	(*commonpb.EntityRef)(nil), // 2: opentelemetry.proto.common.v1.EntityRef
}
