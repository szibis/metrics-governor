...
func (m *ResourceMetrics) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.Resource == nil {
				m.Resource = &resourcepb.Resource{}
			}
...
func (m *ScopeMetrics) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.Scope == nil {
				m.Scope = &commonpb.InstrumentationScope{}
			}
...
func (m *Metric) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 12:
			...
			m.Metadata = append(m.Metadata, &commonpb.KeyValue{})
...
func (m *Exemplar) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			...
			m.FilteredAttributes = append(m.FilteredAttributes, &commonpb.KeyValue{})
