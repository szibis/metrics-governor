...
func (x *ResourceMetrics) GetResource() *resourcepb.Resource {
	if x != nil {
		return x.Resource
	}
	return nil
...
func (x *ScopeMetrics) GetScope() *commonpb.InstrumentationScope {
	if x != nil {
		return x.Scope
	}
	return nil
...
type Metric struct {
	...
	Metadata      []*commonpb.KeyValue `protobuf:"bytes,12,rep,name=metadata,proto3" json:"metadata,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Metric) GetMetadata() []*commonpb.KeyValue {
	if x != nil {
		return x.Metadata
	}
	return nil
...
type NumberDataPoint struct {
	...
	// attribute with the same key).
	// The behavior of software that receives duplicated keys can be unpredictable.
	Attributes []*commonpb.KeyValue `protobuf:"bytes,7,rep,name=attributes,proto3" json:"attributes,omitempty"`
...
func (x *NumberDataPoint) GetAttributes() []*commonpb.KeyValue {
	if x != nil {
		return x.Attributes
	}
	return nil
...
func (x *HistogramDataPoint) GetAttributes() []*commonpb.KeyValue {
	if x != nil {
		return x.Attributes
	}
	return nil
...
type ExponentialHistogramDataPoint struct {
	...
	// attribute with the same key).
	// The behavior of software that receives duplicated keys can be unpredictable.
	Attributes []*commonpb.KeyValue `protobuf:"bytes,1,rep,name=attributes,proto3" json:"attributes,omitempty"`
	// StartTimeUnixNano is optional but strongly encouraged, see the
	// the detailed comments above Metric.
	//
	// Value is UNIX Epoch time in nanoseconds since 00:00:00 UTC on 1 January
...
func (x *ExponentialHistogramDataPoint) GetAttributes() []*commonpb.KeyValue {
	if x != nil {
		return x.Attributes
	}
	return nil
...
func (x *SummaryDataPoint) GetAttributes() []*commonpb.KeyValue {
	if x != nil {
		return x.Attributes
	}
	return nil
...
type Exemplar struct {
	...
	FilteredAttributes []*commonpb.KeyValue `protobuf:"bytes,7,rep,name=filtered_attributes,json=filteredAttributes,proto3" json:"filtered_attributes,omitempty"`
...
func (x *Exemplar) GetFilteredAttributes() []*commonpb.KeyValue {
	if x != nil {
...
const file_opentelemetry_proto_metrics_v1_metrics_proto_rawDesc = "" +
	...
	"'DATA_POINT_FLAGS_NO_RECORDED_VALUE_MASK\x10\x01B\x92\x01\n" +
	"!io.opentelemetry.proto.metrics.v1B\fMetricsProtoP\x01Z<github.com/szibis/metrics-governor/internal/otlpvt/metricspb\xaa\x02\x1eOpenTelemetry.Proto.Metrics.V1b\x06proto3"
...
var file_opentelemetry_proto_metrics_v1_metrics_proto_goTypes = []any{
	...
	(*resourcepb.Resource)(nil),                   // 18: opentelemetry.proto.resource.v1.Resource
	(*commonpb.InstrumentationScope)(nil),         // 19: opentelemetry.proto.common.v1.InstrumentationScope
	(*commonpb.KeyValue)(nil),                     // 20: opentelemetry.proto.common.v1.KeyValue
}
