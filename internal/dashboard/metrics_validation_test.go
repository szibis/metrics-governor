...
var knownMetrics = []string{
	...
	"metrics_governor_limits_rule_dead",
	"metrics_governor_limits_rule_last_match_seconds",
	"metrics_governor_limits_rule_never_matched",
	"metrics_governor_limits_rules_dead_total",
	...
	"metrics_governor_processing_rule_dead",
	"metrics_governor_processing_rule_dropped_total",
	"metrics_governor_processing_rule_input_total",
	"metrics_governor_processing_rule_last_match_seconds",
	"metrics_governor_processing_rule_never_matched",
	"metrics_governor_processing_rule_output_total",
	"metrics_governor_processing_rules_active",
	"metrics_governor_processing_rules_dead_total",
